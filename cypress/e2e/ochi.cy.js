describe('Admin Dashboard - OCHI', () => {
  ...
  it('can upload invalidate ochi data', () => {
    ...
    cy.contains('3. Kesalahan pada baris 4, Tema tidak boleh kosong.').should('exist')
    cy.contains('4. Kesalahan pada baris 6, NIK OCHI leader tidak boleh kosong.').should('exist')
    cy.contains('5. Kesalahan pada baris 7, NIK OCHI leader harus terdiri dari 6 digit.').should('exist')
    cy.contains('OK').click()
