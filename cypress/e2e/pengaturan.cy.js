describe('Admin Dashboard - Pengaturan', () => {
  ...
  it('displays informations on the page', () => {
    ...
    // content
    cy.contains('Pengaturan Halaman Karyawan').should('exist');
    cy.contains('Disable Tema OCHI & QCC').should('exist');
    cy.get('.bx.bx-cog').should('exist')
    ...
    cy.get('.bx.bx-plus').should('exist')
  ...
  it('can disable tema ochi and qcc', () => {
    ...
    cy.contains('blandit nam nulla integer pede justo lacinia eget tincidunt eget tempus').should('not.exist');
  ...
  it('crud record', () => {
    ...
    cy.get('.table.table-hover')
      ...
      .should('exist');
    // add >1 data
    cy.get('.bx.bx-plus').click()
    cy.get('.bx.bx-plus').click()
    cy.get('.bx.bx-x').eq(1).click()
