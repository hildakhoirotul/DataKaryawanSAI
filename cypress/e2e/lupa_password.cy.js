describe('Lupa Password Form', () => {
  ...
  it('display all information', () => {
    ...
    cy.get('.image').should('have.attr', 'src', 'http://192.168.8.167/DataKaryawanSAI/assets/img/login.svg');
  ...
  it('submit with true credentials', () => {
    ...
    cy.url().should('include', 'http://192.168.8.167/DataKaryawanSAI/login')
  ...
  it('submit with wrong nik', () => {
    ...
    cy.url().should('include', 'http://192.168.8.167/DataKaryawanSAI/lupa-password')
