...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparent">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <h1><a href="/home"><span>Home</span></a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li class="dropdown"><a href="#"><span class="nik">{{ Auth::user()->nik }}</span><i class="bi bi-person-circle" style="font-size: 30px;"></i></a>
                        <ul>
                            <li><a href="/change-password"><span><i class="bi bi-house-lock-fill"></i>Ganti Sandi</span></a></li>
    ...
    <script src="assets/vendor/validate.js"></script>
